	...
	return (
		<>
			...
			<div className={styles.bookDetailHeader}>
				<Link
					to={isEditable ? `/books/${bookId}` : "/books"}
					onClick={isEditable ? handleClearInput : null}
				...
				<a
					onClick={handleEdit}
					className={isEditable ? styles.hide : styles.editIcon}
				>
			...
			<div className={styles.bookDetailBody}>
				...
				<div
					className={
						isEditable ? styles.bookDetailEditAll : styles.hide
					}
				>
